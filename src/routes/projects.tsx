        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filtered.map((p) => (
            <article key={p.name} className="group relative overflow-hidden aspect-[4/5]">
              <img src={p.img} alt={`${p.name} — pool table installation in ${p.location}, Rwanda`} loading="lazy" className="w-full h-full object-cover transition-transform duration-[900ms] group-hover:scale-105" />
